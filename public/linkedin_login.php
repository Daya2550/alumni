...
const REDIRECT_URI = 'https://linkedin.free.nf/callback.php';

// LinkedIn Authorization Endpoint with OpenID Connect scopes
...
<head>
    ...
    <title>LinkedIn Login - <?php echo defined('APP_NAME') ? APP_NAME : 'Alumni Portal'; ?></title>
    ...
    <div class="login-container">
        <div class="login-card text-center">
            <div class="mb-4">
                ...
                <h2 class="h4 mb-3">Sign in with LinkedIn</h2>
            ...
            <a href="<?php echo htmlspecialchars($auth_url); ?>" class="linkedin-btn">
